...
public class DynamicBeat extends JFrame {
	...
	private Image Background = new ImageIcon(Main.class.getResource("../images/introbackground(title).jpg")).getImage(); //처음시작 이미지
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("song1Title.png", "music1.jpg", "music4.jpg", "Song1.mp3", "Song1.mp3"));
		trackList.add(new Track("song2Title.png", "music2.jpg", "music5.jpg", "Song2.mp3", "Song2.mp3"));
		trackList.add(new Track("song3Title.png", "music3.jpg", "music6.jpg", "Song3.mp3", "Song3.mp3"));
